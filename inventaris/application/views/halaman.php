...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Inventaris</b>Ku</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/img/jr.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Ahmad Tarmuzi</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets/img/jr.jpg" class="img-circle" alt="User Image">

                <p>
                  Ahmad Tarmuzi - Web Developer
                  <small>Praya 2018</small>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-<?php echo DATE('Y');?> <a href="#">Inventarisku</a>.</strong> All rights
    reserved.
  </footer>
